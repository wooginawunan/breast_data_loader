...
@gin.configurable
def train(save_path, data_class, batch_size=128, callbacks=[]):
    '''
    data_class: 'data_with_segmentations' or 'data'
    '''
    ...
    training_loop(meta_data=None, steps_per_epoch=steps_per_epoch, validation_steps=validation_steps, 
